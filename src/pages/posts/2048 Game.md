...
## 🌐 Play the Game
Experience the game live at [2048.terrylog.cn](https://2048.terrylog.cn){:target="_blank"}. No downloads or installations required—just open the link and start playing!
...
The source code is available on [GitHub](https://github.com/Terryyyds/terrys-2048-game){:target="_blank"}. Feel free to explore, contribute, or fork the project.
...
- [Personal Website](https://terrylog.cn){:target="_blank"}
- [GitHub](https://github.com/Terryyyds){:target="_blank"}
- [LinkedIn](http://linkedin.com/in/yu-deng-396901303){:target="_blank"}
...
[How to Build 2048 Game in React](https://www.youtube.com/watch?v=vI0QArPnkUc){:target="_blank"}
